...
// securityGroupRuleLister implements the SecurityGroupRuleLister interface.
type securityGroupRuleLister struct {
...
func NewSecurityGroupRuleLister(indexer cache.Indexer) SecurityGroupRuleLister {
	return &securityGroupRuleLister{indexer: indexer}
}

// List lists all SecurityGroupRules in the indexer.
func (s *securityGroupRuleLister) List(selector labels.Selector) (ret []*v1alpha1.SecurityGroupRule, err error) {
...
func (s securityGroupRuleNamespaceLister) Get(name string) (*v1alpha1.SecurityGroupRule, error) {
	...
	if !exists {
		return nil, errors.NewNotFound(v1alpha1.Resource("securitygrouprule"), name)
	}
	return obj.(*v1alpha1.SecurityGroupRule), nil
}
