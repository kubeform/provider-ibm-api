...
var autoscalepoliciesResource = schema.GroupVersionResource{Group: "compute.ibm.kubeform.com", Version: "v1alpha1", Resource: "autoscalepolicies"}

var autoscalepoliciesKind = schema.GroupVersionKind{Group: "compute.ibm.kubeform.com", Version: "v1alpha1", Kind: "AutoscalePolicy"}

// Get takes name of the autoscalePolicy, and returns the corresponding autoscalePolicy object, and an error if there is any.
func (c *FakeAutoscalePolicies) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.AutoscalePolicy, err error) {
	obj, err := c.Fake.
...
func (c *FakeAutoscalePolicies) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.AutoscalePolicyList, err error) {
	obj, err := c.Fake.
...
func (c *FakeAutoscalePolicies) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	return c.Fake.
...
func (c *FakeAutoscalePolicies) Create(ctx context.Context, autoscalePolicy *v1alpha1.AutoscalePolicy, opts v1.CreateOptions) (result *v1alpha1.AutoscalePolicy, err error) {
	obj, err := c.Fake.
...
func (c *FakeAutoscalePolicies) Update(ctx context.Context, autoscalePolicy *v1alpha1.AutoscalePolicy, opts v1.UpdateOptions) (result *v1alpha1.AutoscalePolicy, err error) {
	obj, err := c.Fake.
...
func (c *FakeAutoscalePolicies) UpdateStatus(ctx context.Context, autoscalePolicy *v1alpha1.AutoscalePolicy, opts v1.UpdateOptions) (*v1alpha1.AutoscalePolicy, error) {
	obj, err := c.Fake.
...
func (c *FakeAutoscalePolicies) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
	_, err := c.Fake.
...
func (c *FakeAutoscalePolicies) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	action := testing.NewDeleteCollectionAction(autoscalepoliciesResource, c.ns, listOpts)
...
func (c *FakeAutoscalePolicies) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.AutoscalePolicy, err error) {
	obj, err := c.Fake.
