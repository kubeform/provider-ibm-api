...
var usersResource = schema.GroupVersionResource{Group: "compute.ibm.kubeform.com", Version: "v1alpha1", Resource: "users"}

var usersKind = schema.GroupVersionKind{Group: "compute.ibm.kubeform.com", Version: "v1alpha1", Kind: "User"}
