...
type DnsV1alpha1Interface interface {
	...
	DomainsGetter
	DomainRegistrationNameserversesGetter
	GlbsGetter
	GlbMonitorsGetter
	GlbPoolsGetter
	PermittedNetworksGetter
	RecordsGetter
	ResourceRecordsGetter
	ReverseRecordsGetter
	SecondariesGetter
	ZonesGetter
}
