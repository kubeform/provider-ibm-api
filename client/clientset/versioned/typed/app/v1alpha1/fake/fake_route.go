...
var routesResource = schema.GroupVersionResource{Group: "app.ibm.kubeform.com", Version: "v1alpha1", Resource: "routes"}

var routesKind = schema.GroupVersionKind{Group: "app.ibm.kubeform.com", Version: "v1alpha1", Kind: "Route"}
