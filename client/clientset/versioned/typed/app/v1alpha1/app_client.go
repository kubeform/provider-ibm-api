...
type AppV1alpha1Interface interface {
	...
	AppsGetter
	ConfigEnvironmentsGetter
	ConfigFeaturesGetter
	DomainPrivatesGetter
	DomainSharedsGetter
	RoutesGetter
}
