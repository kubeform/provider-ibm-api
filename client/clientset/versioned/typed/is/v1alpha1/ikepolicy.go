...
// IkePoliciesGetter has a method to return a IkePolicyInterface.
...
// ikePolicies implements IkePolicyInterface
type ikePolicies struct {
	client rest.Interface
	ns     string
}

// newIkePolicies returns a IkePolicies
func newIkePolicies(c *IsV1alpha1Client, namespace string) *ikePolicies {
	return &ikePolicies{
		client: c.RESTClient(),
		ns:     namespace,
	}
...
func (c *ikePolicies) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.IkePolicy, err error) {
	result = &v1alpha1.IkePolicy{}
	err = c.client.Get().
		Namespace(c.ns).
...
func (c *ikePolicies) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.IkePolicyList, err error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
	result = &v1alpha1.IkePolicyList{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("ikepolicies").
...
func (c *ikePolicies) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *ikePolicies) Create(ctx context.Context, ikePolicy *v1alpha1.IkePolicy, opts v1.CreateOptions) (result *v1alpha1.IkePolicy, err error) {
	result = &v1alpha1.IkePolicy{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("ikepolicies").
...
func (c *ikePolicies) Update(ctx context.Context, ikePolicy *v1alpha1.IkePolicy, opts v1.UpdateOptions) (result *v1alpha1.IkePolicy, err error) {
	result = &v1alpha1.IkePolicy{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("ikepolicies").
...
func (c *ikePolicies) UpdateStatus(ctx context.Context, ikePolicy *v1alpha1.IkePolicy, opts v1.UpdateOptions) (result *v1alpha1.IkePolicy, err error) {
	result = &v1alpha1.IkePolicy{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("ikepolicies").
...
func (c *ikePolicies) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
...
func (c *ikePolicies) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	var timeout time.Duration
...
func (c *ikePolicies) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.IkePolicy, err error) {
	result = &v1alpha1.IkePolicy{}
