...
// LbListenersGetter has a method to return a LbListenerInterface.
...
// lbListeners implements LbListenerInterface
type lbListeners struct {
	client rest.Interface
	ns     string
}

// newLbListeners returns a LbListeners
func newLbListeners(c *IsV1alpha1Client, namespace string) *lbListeners {
	return &lbListeners{
		client: c.RESTClient(),
		ns:     namespace,
	}
...
func (c *lbListeners) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.LbListener, err error) {
	result = &v1alpha1.LbListener{}
	err = c.client.Get().
		Namespace(c.ns).
...
func (c *lbListeners) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.LbListenerList, err error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
	result = &v1alpha1.LbListenerList{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("lblisteners").
...
func (c *lbListeners) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *lbListeners) Create(ctx context.Context, lbListener *v1alpha1.LbListener, opts v1.CreateOptions) (result *v1alpha1.LbListener, err error) {
	result = &v1alpha1.LbListener{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("lblisteners").
...
func (c *lbListeners) Update(ctx context.Context, lbListener *v1alpha1.LbListener, opts v1.UpdateOptions) (result *v1alpha1.LbListener, err error) {
	result = &v1alpha1.LbListener{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("lblisteners").
...
func (c *lbListeners) UpdateStatus(ctx context.Context, lbListener *v1alpha1.LbListener, opts v1.UpdateOptions) (result *v1alpha1.LbListener, err error) {
	result = &v1alpha1.LbListener{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("lblisteners").
...
func (c *lbListeners) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
...
func (c *lbListeners) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	var timeout time.Duration
...
func (c *lbListeners) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.LbListener, err error) {
	result = &v1alpha1.LbListener{}
