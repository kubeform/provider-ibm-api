...
import (
	v1alpha1 "kubeform.dev/provider-ibm-api/apis/resource/v1alpha1"
...
// ResourceV1alpha1Client is used to interact with features provided by the resource.ibm.kubeform.com group.
...
func (c *ResourceV1alpha1Client) Instances(namespace string) InstanceInterface {
	return newInstances(c, namespace)
}

func (c *ResourceV1alpha1Client) Keys(namespace string) KeyInterface {
	return newKeys(c, namespace)
}

func (c *ResourceV1alpha1Client) Tags(namespace string) TagInterface {
