...
var monitoringsResource = schema.GroupVersionResource{Group: "ob.ibm.kubeform.com", Version: "v1alpha1", Resource: "monitorings"}

var monitoringsKind = schema.GroupVersionKind{Group: "ob.ibm.kubeform.com", Version: "v1alpha1", Kind: "Monitoring"}
...
func (c *FakeMonitorings) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
	_, err := c.Fake.
		Invokes(testing.NewDeleteAction(monitoringsResource, c.ns, name), &v1alpha1.Monitoring{})
