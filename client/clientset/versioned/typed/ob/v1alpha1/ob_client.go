...
type ObV1alpha1Interface interface {
...
func (c *ObV1alpha1Client) Loggings(namespace string) LoggingInterface {
	return newLoggings(c, namespace)
}
...
func NewForConfig(c *rest.Config) (*ObV1alpha1Client, error) {
	...
	return &ObV1alpha1Client{client}, nil
}

// NewForConfigOrDie creates a new ObV1alpha1Client for the given config and
