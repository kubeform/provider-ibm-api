...
var gatewaysResource = schema.GroupVersionResource{Group: "network.ibm.kubeform.com", Version: "v1alpha1", Resource: "gateways"}

var gatewaysKind = schema.GroupVersionKind{Group: "network.ibm.kubeform.com", Version: "v1alpha1", Kind: "Gateway"}
