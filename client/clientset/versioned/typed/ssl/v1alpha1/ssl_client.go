...
// SslV1alpha1Client is used to interact with features provided by the ssl.ibm.kubeform.com group.
type SslV1alpha1Client struct {
	restClient rest.Interface
}

func (c *SslV1alpha1Client) Certificates(namespace string) CertificateInterface {
