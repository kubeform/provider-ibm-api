...
import (
	v1alpha1 "kubeform.dev/provider-ibm-api/apis/service/v1alpha1"
...
// ServiceV1alpha1Client is used to interact with features provided by the service.ibm.kubeform.com group.
type ServiceV1alpha1Client struct {
	restClient rest.Interface
}

func (c *ServiceV1alpha1Client) Instances(namespace string) InstanceInterface {
	return newInstances(c, namespace)
}

func (c *ServiceV1alpha1Client) Keys(namespace string) KeyInterface {
