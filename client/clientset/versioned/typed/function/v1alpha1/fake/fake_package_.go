...
import (
	...
	v1alpha1 "kubeform.dev/provider-ibm-api/apis/function/v1alpha1"
...
var packagesResource = schema.GroupVersionResource{Group: "function.ibm.kubeform.com", Version: "v1alpha1", Resource: "packages"}

var packagesKind = schema.GroupVersionKind{Group: "function.ibm.kubeform.com", Version: "v1alpha1", Kind: "Package"}

// Get takes name of the package_, and returns the corresponding package_ object, and an error if there is any.
...
// Create takes the representation of a package_ and creates it.  Returns the server's representation of the package_, and an error, if there is any.
func (c *FakePackages) Create(ctx context.Context, package_ *v1alpha1.Package, opts v1.CreateOptions) (result *v1alpha1.Package, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewCreateAction(packagesResource, c.ns, package_), &v1alpha1.Package{})
...
// Update takes the representation of a package_ and updates it. Returns the server's representation of the package_, and an error, if there is any.
func (c *FakePackages) Update(ctx context.Context, package_ *v1alpha1.Package, opts v1.UpdateOptions) (result *v1alpha1.Package, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewUpdateAction(packagesResource, c.ns, package_), &v1alpha1.Package{})
...
func (c *FakePackages) UpdateStatus(ctx context.Context, package_ *v1alpha1.Package, opts v1.UpdateOptions) (*v1alpha1.Package, error) {
	obj, err := c.Fake.
		Invokes(testing.NewUpdateSubresourceAction(packagesResource, "status", c.ns, package_), &v1alpha1.Package{})
...
// Delete takes name of the package_ and deletes it. Returns an error if one occurs.
...
// Patch applies the patch and returns the patched package_.
