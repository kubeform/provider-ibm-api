...
func newPackages(c *FunctionV1alpha1Client, namespace string) *packages {
	return &packages{
		client: c.RESTClient(),
		ns:     namespace,
	}
...
func (c *packages) Create(ctx context.Context, package_ *v1alpha1.Package, opts v1.CreateOptions) (result *v1alpha1.Package, err error) {
	result = &v1alpha1.Package{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("packages").
...
func (c *packages) Update(ctx context.Context, package_ *v1alpha1.Package, opts v1.UpdateOptions) (result *v1alpha1.Package, err error) {
	result = &v1alpha1.Package{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("packages").
...
func (c *packages) UpdateStatus(ctx context.Context, package_ *v1alpha1.Package, opts v1.UpdateOptions) (result *v1alpha1.Package, err error) {
	result = &v1alpha1.Package{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("packages").
