...
var ratelimitsResource = schema.GroupVersionResource{Group: "cis.ibm.kubeform.com", Version: "v1alpha1", Resource: "ratelimits"}

var ratelimitsKind = schema.GroupVersionKind{Group: "cis.ibm.kubeform.com", Version: "v1alpha1", Kind: "RateLimit"}
...
func (c *FakeRateLimits) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
	_, err := c.Fake.
		Invokes(testing.NewDeleteAction(ratelimitsResource, c.ns, name), &v1alpha1.RateLimit{})
