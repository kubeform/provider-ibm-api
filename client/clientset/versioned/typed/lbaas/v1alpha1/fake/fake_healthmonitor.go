...
var healthmonitorsResource = schema.GroupVersionResource{Group: "lbaas.ibm.kubeform.com", Version: "v1alpha1", Resource: "healthmonitors"}

var healthmonitorsKind = schema.GroupVersionKind{Group: "lbaas.ibm.kubeform.com", Version: "v1alpha1", Kind: "HealthMonitor"}
...
func (c *FakeHealthMonitors) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
	_, err := c.Fake.
		Invokes(testing.NewDeleteAction(healthmonitorsResource, c.ns, name), &v1alpha1.HealthMonitor{})
