...
func NewForConfig(c *rest.Config) (*LbaasV1alpha1Client, error) {
	...
	return &LbaasV1alpha1Client{client}, nil
}

// NewForConfigOrDie creates a new LbaasV1alpha1Client for the given config and
...
func New(c rest.Interface) *LbaasV1alpha1Client {
	return &LbaasV1alpha1Client{c}
}
