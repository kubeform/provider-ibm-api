...
// VpxServicesGetter has a method to return a VpxServiceInterface.
...
// vpxServices implements VpxServiceInterface
type vpxServices struct {
	client rest.Interface
	ns     string
}

// newVpxServices returns a VpxServices
func newVpxServices(c *LbV1alpha1Client, namespace string) *vpxServices {
	return &vpxServices{
		client: c.RESTClient(),
		ns:     namespace,
	}
...
func (c *vpxServices) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.VpxService, err error) {
	result = &v1alpha1.VpxService{}
	err = c.client.Get().
		Namespace(c.ns).
...
func (c *vpxServices) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.VpxServiceList, err error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
	result = &v1alpha1.VpxServiceList{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("vpxservices").
...
func (c *vpxServices) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *vpxServices) Create(ctx context.Context, vpxService *v1alpha1.VpxService, opts v1.CreateOptions) (result *v1alpha1.VpxService, err error) {
	result = &v1alpha1.VpxService{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("vpxservices").
...
func (c *vpxServices) Update(ctx context.Context, vpxService *v1alpha1.VpxService, opts v1.UpdateOptions) (result *v1alpha1.VpxService, err error) {
	result = &v1alpha1.VpxService{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("vpxservices").
		Name(vpxService.Name).
		VersionedParams(&opts, scheme.ParameterCodec).
		Body(vpxService).
		Do(ctx).
		Into(result)
...
func (c *vpxServices) UpdateStatus(ctx context.Context, vpxService *v1alpha1.VpxService, opts v1.UpdateOptions) (result *v1alpha1.VpxService, err error) {
	result = &v1alpha1.VpxService{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("vpxservices").
...
func (c *vpxServices) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
...
func (c *vpxServices) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	var timeout time.Duration
...
func (c *vpxServices) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.VpxService, err error) {
	result = &v1alpha1.VpxService{}
