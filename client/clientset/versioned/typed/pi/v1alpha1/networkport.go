...
// NetworkPortsGetter has a method to return a NetworkPortInterface.
...
// networkPorts implements NetworkPortInterface
type networkPorts struct {
	client rest.Interface
	ns     string
}

// newNetworkPorts returns a NetworkPorts
func newNetworkPorts(c *PiV1alpha1Client, namespace string) *networkPorts {
	return &networkPorts{
		client: c.RESTClient(),
		ns:     namespace,
	}
...
func (c *networkPorts) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.NetworkPort, err error) {
	result = &v1alpha1.NetworkPort{}
	err = c.client.Get().
		Namespace(c.ns).
...
func (c *networkPorts) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.NetworkPortList, err error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
	result = &v1alpha1.NetworkPortList{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("networkports").
...
func (c *networkPorts) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *networkPorts) Create(ctx context.Context, networkPort *v1alpha1.NetworkPort, opts v1.CreateOptions) (result *v1alpha1.NetworkPort, err error) {
	result = &v1alpha1.NetworkPort{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("networkports").
...
func (c *networkPorts) Update(ctx context.Context, networkPort *v1alpha1.NetworkPort, opts v1.UpdateOptions) (result *v1alpha1.NetworkPort, err error) {
	result = &v1alpha1.NetworkPort{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("networkports").
...
func (c *networkPorts) UpdateStatus(ctx context.Context, networkPort *v1alpha1.NetworkPort, opts v1.UpdateOptions) (result *v1alpha1.NetworkPort, err error) {
	result = &v1alpha1.NetworkPort{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("networkports").
...
func (c *networkPorts) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
...
func (c *networkPorts) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	var timeout time.Duration
...
func (c *networkPorts) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.NetworkPort, err error) {
	result = &v1alpha1.NetworkPort{}
