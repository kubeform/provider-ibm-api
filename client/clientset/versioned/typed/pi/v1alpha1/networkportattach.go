...
// NetworkPortAttachesGetter has a method to return a NetworkPortAttachInterface.
...
// networkPortAttaches implements NetworkPortAttachInterface
type networkPortAttaches struct {
	client rest.Interface
	ns     string
}

// newNetworkPortAttaches returns a NetworkPortAttaches
func newNetworkPortAttaches(c *PiV1alpha1Client, namespace string) *networkPortAttaches {
	return &networkPortAttaches{
		client: c.RESTClient(),
		ns:     namespace,
	}
}
...
func (c *networkPortAttaches) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.NetworkPortAttach, err error) {
	result = &v1alpha1.NetworkPortAttach{}
	err = c.client.Get().
		Namespace(c.ns).
...
func (c *networkPortAttaches) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.NetworkPortAttachList, err error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
	result = &v1alpha1.NetworkPortAttachList{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("networkportattaches").
...
func (c *networkPortAttaches) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *networkPortAttaches) Create(ctx context.Context, networkPortAttach *v1alpha1.NetworkPortAttach, opts v1.CreateOptions) (result *v1alpha1.NetworkPortAttach, err error) {
	result = &v1alpha1.NetworkPortAttach{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("networkportattaches").
		VersionedParams(&opts, scheme.ParameterCodec).
		Body(networkPortAttach).
		Do(ctx).
		Into(result)
	return
}
...
func (c *networkPortAttaches) Update(ctx context.Context, networkPortAttach *v1alpha1.NetworkPortAttach, opts v1.UpdateOptions) (result *v1alpha1.NetworkPortAttach, err error) {
	result = &v1alpha1.NetworkPortAttach{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("networkportattaches").
		Name(networkPortAttach.Name).
		VersionedParams(&opts, scheme.ParameterCodec).
		Body(networkPortAttach).
		Do(ctx).
		Into(result)
...
func (c *networkPortAttaches) UpdateStatus(ctx context.Context, networkPortAttach *v1alpha1.NetworkPortAttach, opts v1.UpdateOptions) (result *v1alpha1.NetworkPortAttach, err error) {
	result = &v1alpha1.NetworkPortAttach{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("networkportattaches").
...
func (c *networkPortAttaches) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
...
func (c *networkPortAttaches) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	var timeout time.Duration
...
func (c *networkPortAttaches) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.NetworkPortAttach, err error) {
	result = &v1alpha1.NetworkPortAttach{}
