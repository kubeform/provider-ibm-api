...
var keysResource = schema.GroupVersionResource{Group: "kms.ibm.kubeform.com", Version: "v1alpha1", Resource: "keys"}

var keysKind = schema.GroupVersionKind{Group: "kms.ibm.kubeform.com", Version: "v1alpha1", Kind: "Key"}
