...
func newAuthorizationPolicies(c *IamV1alpha1Client, namespace string) *authorizationPolicies {
...
func (c *authorizationPolicies) UpdateStatus(ctx context.Context, authorizationPolicy *v1alpha1.AuthorizationPolicy, opts v1.UpdateOptions) (result *v1alpha1.AuthorizationPolicy, err error) {
	result = &v1alpha1.AuthorizationPolicy{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("authorizationpolicies").
