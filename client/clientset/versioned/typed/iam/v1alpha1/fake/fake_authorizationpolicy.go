...
var authorizationpoliciesResource = schema.GroupVersionResource{Group: "iam.ibm.kubeform.com", Version: "v1alpha1", Resource: "authorizationpolicies"}

var authorizationpoliciesKind = schema.GroupVersionKind{Group: "iam.ibm.kubeform.com", Version: "v1alpha1", Kind: "AuthorizationPolicy"}
...
func (c *FakeAuthorizationPolicies) UpdateStatus(ctx context.Context, authorizationPolicy *v1alpha1.AuthorizationPolicy, opts v1.UpdateOptions) (*v1alpha1.AuthorizationPolicy, error) {
	obj, err := c.Fake.
		Invokes(testing.NewUpdateSubresourceAction(authorizationpoliciesResource, "status", c.ns, authorizationPolicy), &v1alpha1.AuthorizationPolicy{})
...
func (c *FakeAuthorizationPolicies) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
	_, err := c.Fake.
		Invokes(testing.NewDeleteAction(authorizationpoliciesResource, c.ns, name), &v1alpha1.AuthorizationPolicy{})
