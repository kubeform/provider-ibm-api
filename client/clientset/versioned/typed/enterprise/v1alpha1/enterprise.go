...
// EnterprisesGetter has a method to return a EnterpriseInterface.
...
// enterprises implements EnterpriseInterface
type enterprises struct {
	client rest.Interface
	ns     string
}

// newEnterprises returns a Enterprises
func newEnterprises(c *EnterpriseV1alpha1Client, namespace string) *enterprises {
	return &enterprises{
		client: c.RESTClient(),
		ns:     namespace,
	}
...
func (c *enterprises) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.Enterprise, err error) {
	result = &v1alpha1.Enterprise{}
	err = c.client.Get().
		Namespace(c.ns).
...
func (c *enterprises) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.EnterpriseList, err error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
	result = &v1alpha1.EnterpriseList{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("enterprises").
...
func (c *enterprises) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *enterprises) Create(ctx context.Context, enterprise *v1alpha1.Enterprise, opts v1.CreateOptions) (result *v1alpha1.Enterprise, err error) {
	result = &v1alpha1.Enterprise{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("enterprises").
...
func (c *enterprises) Update(ctx context.Context, enterprise *v1alpha1.Enterprise, opts v1.UpdateOptions) (result *v1alpha1.Enterprise, err error) {
	result = &v1alpha1.Enterprise{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("enterprises").
...
func (c *enterprises) UpdateStatus(ctx context.Context, enterprise *v1alpha1.Enterprise, opts v1.UpdateOptions) (result *v1alpha1.Enterprise, err error) {
	result = &v1alpha1.Enterprise{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("enterprises").
...
func (c *enterprises) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
...
func (c *enterprises) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	var timeout time.Duration
...
func (c *enterprises) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.Enterprise, err error) {
	result = &v1alpha1.Enterprise{}
