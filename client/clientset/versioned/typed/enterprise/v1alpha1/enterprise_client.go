...
func NewForConfig(c *rest.Config) (*EnterpriseV1alpha1Client, error) {
	...
	return &EnterpriseV1alpha1Client{client}, nil
}

// NewForConfigOrDie creates a new EnterpriseV1alpha1Client for the given config and
...
func New(c rest.Interface) *EnterpriseV1alpha1Client {
	return &EnterpriseV1alpha1Client{c}
}
