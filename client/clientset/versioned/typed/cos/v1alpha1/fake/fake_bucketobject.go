...
type FakeBucketObjects struct {
	Fake *FakeCosV1alpha1
	ns   string
}

var bucketobjectsResource = schema.GroupVersionResource{Group: "cos.ibm.kubeform.com", Version: "v1alpha1", Resource: "bucketobjects"}

var bucketobjectsKind = schema.GroupVersionKind{Group: "cos.ibm.kubeform.com", Version: "v1alpha1", Kind: "BucketObject"}
