...
var catalogsResource = schema.GroupVersionResource{Group: "cm.ibm.kubeform.com", Version: "v1alpha1", Resource: "catalogs"}

var catalogsKind = schema.GroupVersionKind{Group: "cm.ibm.kubeform.com", Version: "v1alpha1", Kind: "Catalog"}
...
func (c *FakeCatalogs) UpdateStatus(ctx context.Context, catalog *v1alpha1.Catalog, opts v1.UpdateOptions) (*v1alpha1.Catalog, error) {
	obj, err := c.Fake.
		Invokes(testing.NewUpdateSubresourceAction(catalogsResource, "status", c.ns, catalog), &v1alpha1.Catalog{})
