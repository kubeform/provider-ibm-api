...
// EventV1alpha1Client is used to interact with features provided by the event.ibm.kubeform.com group.
type EventV1alpha1Client struct {
	restClient rest.Interface
}

func (c *EventV1alpha1Client) StreamsTopics(namespace string) StreamsTopicInterface {
	return newStreamsTopics(c, namespace)
}
