...
// AddonsesGetter has a method to return a AddonsInterface.
...
// addonses implements AddonsInterface
type addonses struct {
	client rest.Interface
	ns     string
}

// newAddonses returns a Addonses
func newAddonses(c *ContainerV1alpha1Client, namespace string) *addonses {
	return &addonses{
		client: c.RESTClient(),
		ns:     namespace,
	}
...
func (c *addonses) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.Addons, err error) {
	result = &v1alpha1.Addons{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("addonses").
		Name(name).
...
func (c *addonses) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.AddonsList, err error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
	result = &v1alpha1.AddonsList{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("addonses").
...
func (c *addonses) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *addonses) Create(ctx context.Context, addons *v1alpha1.Addons, opts v1.CreateOptions) (result *v1alpha1.Addons, err error) {
	result = &v1alpha1.Addons{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("addonses").
...
func (c *addonses) Update(ctx context.Context, addons *v1alpha1.Addons, opts v1.UpdateOptions) (result *v1alpha1.Addons, err error) {
	result = &v1alpha1.Addons{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("addonses").
...
func (c *addonses) UpdateStatus(ctx context.Context, addons *v1alpha1.Addons, opts v1.UpdateOptions) (result *v1alpha1.Addons, err error) {
	result = &v1alpha1.Addons{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("addonses").
...
func (c *addonses) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
...
func (c *addonses) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	var timeout time.Duration
...
func (c *addonses) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.Addons, err error) {
	result = &v1alpha1.Addons{}
