...
// BindServicesGetter has a method to return a BindServiceInterface.
...
// bindServices implements BindServiceInterface
type bindServices struct {
	client rest.Interface
	ns     string
}

// newBindServices returns a BindServices
func newBindServices(c *ContainerV1alpha1Client, namespace string) *bindServices {
	return &bindServices{
		client: c.RESTClient(),
		ns:     namespace,
	}
...
func (c *bindServices) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.BindService, err error) {
	result = &v1alpha1.BindService{}
	err = c.client.Get().
		Namespace(c.ns).
...
func (c *bindServices) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.BindServiceList, err error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
	result = &v1alpha1.BindServiceList{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("bindservices").
...
func (c *bindServices) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *bindServices) Create(ctx context.Context, bindService *v1alpha1.BindService, opts v1.CreateOptions) (result *v1alpha1.BindService, err error) {
	result = &v1alpha1.BindService{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("bindservices").
...
func (c *bindServices) Update(ctx context.Context, bindService *v1alpha1.BindService, opts v1.UpdateOptions) (result *v1alpha1.BindService, err error) {
	result = &v1alpha1.BindService{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("bindservices").
...
func (c *bindServices) UpdateStatus(ctx context.Context, bindService *v1alpha1.BindService, opts v1.UpdateOptions) (result *v1alpha1.BindService, err error) {
	result = &v1alpha1.BindService{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("bindservices").
...
func (c *bindServices) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
...
func (c *bindServices) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	var timeout time.Duration
...
func (c *bindServices) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.BindService, err error) {
	result = &v1alpha1.BindService{}
