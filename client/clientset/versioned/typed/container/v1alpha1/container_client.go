...
type ContainerV1alpha1Interface interface {
	...
	BindServicesGetter
	ClustersGetter
	ClusterFeaturesGetter
	VpcAlbsGetter
	VpcClustersGetter
	VpcWorkerPoolsGetter
	WorkerPoolsGetter
	WorkerPoolZoneAttachmentsGetter
}
...
func (c *ContainerV1alpha1Client) Addonses(namespace string) AddonsInterface {
	return newAddonses(c, namespace)
}
...
func (c *ContainerV1alpha1Client) WorkerPoolZoneAttachments(namespace string) WorkerPoolZoneAttachmentInterface {
	return newWorkerPoolZoneAttachments(c, namespace)
}
