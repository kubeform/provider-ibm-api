...
// ClusterFeaturesGetter has a method to return a ClusterFeatureInterface.
...
// clusterFeatures implements ClusterFeatureInterface
type clusterFeatures struct {
	client rest.Interface
	ns     string
}

// newClusterFeatures returns a ClusterFeatures
func newClusterFeatures(c *ContainerV1alpha1Client, namespace string) *clusterFeatures {
...
func (c *clusterFeatures) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.ClusterFeature, err error) {
	result = &v1alpha1.ClusterFeature{}
	err = c.client.Get().
		Namespace(c.ns).
...
func (c *clusterFeatures) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.ClusterFeatureList, err error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
	result = &v1alpha1.ClusterFeatureList{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("clusterfeatures").
...
func (c *clusterFeatures) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *clusterFeatures) Create(ctx context.Context, clusterFeature *v1alpha1.ClusterFeature, opts v1.CreateOptions) (result *v1alpha1.ClusterFeature, err error) {
	result = &v1alpha1.ClusterFeature{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("clusterfeatures").
...
func (c *clusterFeatures) Update(ctx context.Context, clusterFeature *v1alpha1.ClusterFeature, opts v1.UpdateOptions) (result *v1alpha1.ClusterFeature, err error) {
	result = &v1alpha1.ClusterFeature{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("clusterfeatures").
...
func (c *clusterFeatures) UpdateStatus(ctx context.Context, clusterFeature *v1alpha1.ClusterFeature, opts v1.UpdateOptions) (result *v1alpha1.ClusterFeature, err error) {
	result = &v1alpha1.ClusterFeature{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("clusterfeatures").
...
func (c *clusterFeatures) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
...
func (c *clusterFeatures) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	var timeout time.Duration
...
func (c *clusterFeatures) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.ClusterFeature, err error) {
	result = &v1alpha1.ClusterFeature{}
