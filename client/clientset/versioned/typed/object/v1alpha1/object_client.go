...
// ObjectV1alpha1Client is used to interact with features provided by the object.ibm.kubeform.com group.
type ObjectV1alpha1Client struct {
	restClient rest.Interface
}

func (c *ObjectV1alpha1Client) StorageAccounts(namespace string) StorageAccountInterface {
