...
type ApigatewayV1alpha1Interface interface {
	...
	EndpointsGetter
	EndpointSubscriptionsGetter
}

// ApigatewayV1alpha1Client is used to interact with features provided by the apigateway.ibm.kubeform.com group.
type ApigatewayV1alpha1Client struct {
	restClient rest.Interface
}

func (c *ApigatewayV1alpha1Client) Endpoints(namespace string) EndpointInterface {
	return newEndpoints(c, namespace)
}

func (c *ApigatewayV1alpha1Client) EndpointSubscriptions(namespace string) EndpointSubscriptionInterface {
	return newEndpointSubscriptions(c, namespace)
}
