	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.DlV1alpha1().Gateways(namespace).List(context.TODO(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.DlV1alpha1().Gateways(namespace).Watch(context.TODO(), options)
			},
		},
		&dlv1alpha1.Gateway{},
		resyncPeriod,
...
func (f *gatewayInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&dlv1alpha1.Gateway{}, f.defaultInformer)
}
