	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.CosV1alpha1().Buckets(namespace).List(context.TODO(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.CosV1alpha1().Buckets(namespace).Watch(context.TODO(), options)
			},
		},
		&cosv1alpha1.Bucket{},
		resyncPeriod,
...
func (f *bucketInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&cosv1alpha1.Bucket{}, f.defaultInformer)
}
