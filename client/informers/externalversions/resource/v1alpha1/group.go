	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.ResourceV1alpha1().Groups(namespace).List(context.TODO(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.ResourceV1alpha1().Groups(namespace).Watch(context.TODO(), options)
			},
		},
		&resourcev1alpha1.Group{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *groupInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&resourcev1alpha1.Group{}, f.defaultInformer)
}
