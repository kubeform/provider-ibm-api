...
import (
	...
	v1alpha1 "kubeform.dev/provider-ibm-api/client/listers/resource/v1alpha1"
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.ResourceV1alpha1().Instances(namespace).List(context.TODO(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.ResourceV1alpha1().Instances(namespace).Watch(context.TODO(), options)
			},
		},
		&resourcev1alpha1.Instance{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *instanceInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&resourcev1alpha1.Instance{}, f.defaultInformer)
}
