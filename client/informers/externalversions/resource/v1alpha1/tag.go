	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.ResourceV1alpha1().Tags(namespace).List(context.TODO(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.ResourceV1alpha1().Tags(namespace).Watch(context.TODO(), options)
			},
		},
		&resourcev1alpha1.Tag{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *tagInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&resourcev1alpha1.Tag{}, f.defaultInformer)
}
