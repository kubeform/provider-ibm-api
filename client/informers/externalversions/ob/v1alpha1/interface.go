...
type Interface interface {
	// Loggings returns a LoggingInformer.
	Loggings() LoggingInformer
...
// Loggings returns a LoggingInformer.
func (v *version) Loggings() LoggingInformer {
	return &loggingInformer{factory: v.factory, namespace: v.namespace, tweakListOptions: v.tweakListOptions}
}
