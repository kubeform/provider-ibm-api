...
type Interface interface {
	...
	// EndpointSubscriptions returns a EndpointSubscriptionInformer.
	EndpointSubscriptions() EndpointSubscriptionInformer
}
...
// EndpointSubscriptions returns a EndpointSubscriptionInformer.
func (v *version) EndpointSubscriptions() EndpointSubscriptionInformer {
	return &endpointSubscriptionInformer{factory: v.factory, namespace: v.namespace, tweakListOptions: v.tweakListOptions}
}
