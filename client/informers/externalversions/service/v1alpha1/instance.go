...
import (
	...
	v1alpha1 "kubeform.dev/provider-ibm-api/client/listers/service/v1alpha1"
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.ServiceV1alpha1().Instances(namespace).List(context.TODO(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.ServiceV1alpha1().Instances(namespace).Watch(context.TODO(), options)
			},
		},
		&servicev1alpha1.Instance{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *instanceInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&servicev1alpha1.Instance{}, f.defaultInformer)
}
