	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.IamV1alpha1().ServicePolicies(namespace).List(context.TODO(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.IamV1alpha1().ServicePolicies(namespace).Watch(context.TODO(), options)
			},
		},
		&iamv1alpha1.ServicePolicy{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *servicePolicyInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&iamv1alpha1.ServicePolicy{}, f.defaultInformer)
}
