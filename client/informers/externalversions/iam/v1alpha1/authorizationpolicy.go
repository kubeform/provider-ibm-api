	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.IamV1alpha1().AuthorizationPolicies(namespace).List(context.TODO(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.IamV1alpha1().AuthorizationPolicies(namespace).Watch(context.TODO(), options)
			},
		},
		&iamv1alpha1.AuthorizationPolicy{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *authorizationPolicyInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&iamv1alpha1.AuthorizationPolicy{}, f.defaultInformer)
}
