	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.CmV1alpha1().Versions(namespace).List(context.TODO(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.CmV1alpha1().Versions(namespace).Watch(context.TODO(), options)
			},
		},
		&cmv1alpha1.Version{},
		resyncPeriod,
...
func (f *versionInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&cmv1alpha1.Version{}, f.defaultInformer)
}
