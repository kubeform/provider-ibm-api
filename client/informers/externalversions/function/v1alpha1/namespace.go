	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.FunctionV1alpha1().Namespaces(namespace).List(context.TODO(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.FunctionV1alpha1().Namespaces(namespace).Watch(context.TODO(), options)
			},
		},
		&functionv1alpha1.Namespace{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *namespaceInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&functionv1alpha1.Namespace{}, f.defaultInformer)
}
