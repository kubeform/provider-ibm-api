...
// Lbaases returns a LbaasInformer.
func (v *version) Lbaases() LbaasInformer {
	return &lbaasInformer{factory: v.factory, namespace: v.namespace, tweakListOptions: v.tweakListOptions}
}

// ServerInstanceAttachments returns a ServerInstanceAttachmentInformer.
func (v *version) ServerInstanceAttachments() ServerInstanceAttachmentInformer {
	return &serverInstanceAttachmentInformer{factory: v.factory, namespace: v.namespace, tweakListOptions: v.tweakListOptions}
}
