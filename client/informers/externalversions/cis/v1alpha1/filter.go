	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.CisV1alpha1().Filters(namespace).List(context.TODO(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.CisV1alpha1().Filters(namespace).Watch(context.TODO(), options)
			},
		},
		&cisv1alpha1.Filter{},
		resyncPeriod,
...
func (f *filterInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&cisv1alpha1.Filter{}, f.defaultInformer)
}
