...
// SecurityGroupRuleInformer provides access to a shared informer and lister for
// SecurityGroupRules.
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.IsV1alpha1().SecurityGroupRules(namespace).List(context.TODO(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.IsV1alpha1().SecurityGroupRules(namespace).Watch(context.TODO(), options)
			},
		},
		&isv1alpha1.SecurityGroupRule{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *securityGroupRuleInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&isv1alpha1.SecurityGroupRule{}, f.defaultInformer)
}

func (f *securityGroupRuleInformer) Lister() v1alpha1.SecurityGroupRuleLister {
	return v1alpha1.NewSecurityGroupRuleLister(f.Informer().GetIndexer())
}
