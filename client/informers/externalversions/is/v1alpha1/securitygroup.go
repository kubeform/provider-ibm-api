	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.IsV1alpha1().SecurityGroups(namespace).List(context.TODO(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.IsV1alpha1().SecurityGroups(namespace).Watch(context.TODO(), options)
			},
		},
		&isv1alpha1.SecurityGroup{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *securityGroupInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&isv1alpha1.SecurityGroup{}, f.defaultInformer)
}
