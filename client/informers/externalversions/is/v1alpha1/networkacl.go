	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.IsV1alpha1().NetworkACLs(namespace).List(context.TODO(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.IsV1alpha1().NetworkACLs(namespace).Watch(context.TODO(), options)
			},
		},
		&isv1alpha1.NetworkACL{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *networkACLInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&isv1alpha1.NetworkACL{}, f.defaultInformer)
}
