	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.IsV1alpha1().InstanceTemplates(namespace).List(context.TODO(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.IsV1alpha1().InstanceTemplates(namespace).Watch(context.TODO(), options)
			},
		},
		&isv1alpha1.InstanceTemplate{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *instanceTemplateInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&isv1alpha1.InstanceTemplate{}, f.defaultInformer)
}
