...
import (
	...
	v1alpha1 "kubeform.dev/provider-ibm-api/client/listers/database/v1alpha1"
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.DatabaseV1alpha1().Databases(namespace).List(context.TODO(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.DatabaseV1alpha1().Databases(namespace).Watch(context.TODO(), options)
			},
		},
...
func (f *databaseInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&databasev1alpha1.Database{}, f.defaultInformer)
}
