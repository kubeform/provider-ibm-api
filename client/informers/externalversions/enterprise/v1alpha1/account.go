	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.EnterpriseV1alpha1().Accounts(namespace).List(context.TODO(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.EnterpriseV1alpha1().Accounts(namespace).Watch(context.TODO(), options)
			},
		},
		&enterprisev1alpha1.Account{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *accountInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&enterprisev1alpha1.Account{}, f.defaultInformer)
}
