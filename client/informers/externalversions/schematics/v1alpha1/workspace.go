	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.SchematicsV1alpha1().Workspaces(namespace).List(context.TODO(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.SchematicsV1alpha1().Workspaces(namespace).Watch(context.TODO(), options)
			},
		},
		&schematicsv1alpha1.Workspace{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *workspaceInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&schematicsv1alpha1.Workspace{}, f.defaultInformer)
}
