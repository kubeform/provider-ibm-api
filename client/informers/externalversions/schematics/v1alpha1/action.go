	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.SchematicsV1alpha1().Actions(namespace).List(context.TODO(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.SchematicsV1alpha1().Actions(namespace).Watch(context.TODO(), options)
			},
		},
		&schematicsv1alpha1.Action{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *actionInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&schematicsv1alpha1.Action{}, f.defaultInformer)
}
