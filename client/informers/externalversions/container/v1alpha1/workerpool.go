	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.ContainerV1alpha1().WorkerPools(namespace).List(context.TODO(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.ContainerV1alpha1().WorkerPools(namespace).Watch(context.TODO(), options)
			},
		},
		&containerv1alpha1.WorkerPool{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *workerPoolInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&containerv1alpha1.WorkerPool{}, f.defaultInformer)
}
