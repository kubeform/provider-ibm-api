...
type GatewayEndpoint struct {
	...
	Spec              GatewayEndpointSpec   `json:"spec,omitempty"`
	Status            GatewayEndpointStatus `json:"status,omitempty"`
}

type GatewayEndpointSpec struct {
	State *GatewayEndpointSpecResource `json:"state,omitempty" tf:"-"`

	Resource GatewayEndpointSpecResource `json:"resource" tf:"resource"`
...
type GatewayEndpointSpecResource struct {
...
// GatewayEndpointList is a list of GatewayEndpoints
type GatewayEndpointList struct {
	metav1.TypeMeta `json:",inline"`
	metav1.ListMeta `json:"metadata,omitempty"`
	// Items is a list of GatewayEndpoint CRD objects
	Items []GatewayEndpoint `json:"items,omitempty"`
}
